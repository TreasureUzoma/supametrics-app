...
export const Badge = ({ text }: { text: string }) => {
  return (
    <Link
      href="/blog/introducing-public-beta"
      target="_blank"
    ...
    >
      <span className="absolute inset-0 overflow-hidden rounded-full">
        <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(79,23,135,0.6)_0%,rgba(79,23,135,0)_5%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100"></span>
      </span>
