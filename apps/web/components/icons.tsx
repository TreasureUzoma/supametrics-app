export const Icons = ({ type = '', color = '#6B7280', width = '24px', height = '24px', className = '' }) => {
	switch (type) {
		case 'menu':
			return (
				<svg
		...
		case 'analytics':
			return (
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width={width} height={height} fill={color}>
					<path fill={color} d="M640-160v-280h160v280H640Zm-240 0v-640h160v640H400Zm-240 0v-440h160v440H160Z" />
				</svg>
			);
